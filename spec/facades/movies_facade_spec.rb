...
describe MoviesFacade do
  ...
  let(:movies_facade) { described_class.new }

  describe '#top_twenty' do
    it 'returns an array of top twenty movies' do
      top_twenty_movies = [
        { id: 1, title: 'Movie 1', vote_average: 8.0, runtime: 120, genres: %w[Action Adventure],
          overview: 'A great movie', poster_path: 'https://image.tmdb.org/t/p/w500/abc.jpg' },
        { id: 2, title: 'Movie 2', vote_average: 7.5, runtime: 110, genres: %w[Comedy Drama],
          overview: 'A funny movie', poster_path: 'https://image.tmdb.org/t/p/w500/def.jpg' }
      ]
      ...
      expect(result[0].genres).to eq(%w[Action Adventure])
      ...
      expect(result[1].genres).to eq(%w[Comedy Drama])
  ...
  describe '#search' do
    ...
    it 'returns an array of movies matching the search query' do
      search_results = [
        { id: 1, title: 'Star Wars: Episode IV - A New Hope', vote_average: 8.7, runtime: 121,
          genres: ['Action', 'Adventure', 'Fantasy', 'Science Fiction'], overview: 'The classic adventure of Luke Skywalker', poster_path: '/starwars1.jpg' },
        { id: 2, title: 'Star Wars: Episode V - The Empire Strikes Back', vote_average: 8.8, runtime: 124,
          genres: ['Action', 'Adventure', 'Fantasy', 'Science Fiction'], overview: 'The rebels fight back against the empire', poster_path: '/starwars2.jpg' }
      ]
  ...
  describe '#cast_details' do
    it 'returns cast details' do
      cast_data = [{ id: 1, name: 'Actor 1', character: 'Character 1' },
